...
public class Enemies extends Sprite<SpriteType, SpriteState>{
  ...
  private static Vector startingAim = new Vector(0, 1, 1);
  private int healthPoints;
  private int healthBars;

  public Enemies(String EnemyVar, int healthPoints, int healthBars, int Radius, Vector Position, Vector EnemyAim, Vector Velocity) {
    super(SpriteType.Enemy, EnemyVar, SpriteState.aim, Radius, Position, EnemyAim, Velocity);
